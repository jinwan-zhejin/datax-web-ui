    ...
    <el-dialog
        ...
        <el-row class="set-combin-inner">
            <el-col :span="8" class="set-combin-l">
                ...
                <el-row class="mt10">
                    <el-input placeholder="请输入表名查询" size="small" @keyup.enter.native="searchTable" v-model="tableName" class="input-with-select">
                        <el-button size="small" slot="append" icon="el-icon-search" @click="searchTable"></el-button>
                    </el-input>
                </el-row>
