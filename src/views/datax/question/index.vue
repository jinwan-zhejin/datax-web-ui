<template>
    <section class="quality-rule main-outer">
        ...
        <el-row class="main-inner">
            <div class="search_list">
                ...
                <el-row :gutter="20" class="mt15">
                    <el-col :span="10">
                        <span>所属数据源:</span>
                        <el-select v-model="sourceId" placeholder="请选择" @change="changeSelect" size='small'>
                ...
                <el-row :gutter="20" class="mt15">
                    <el-col :span="24">
                        <el-button size="mini" class="grey-btn" @click="batchOperate" :disabled="this.deleteSelection.length<=0">处理</el-button>
                        <div style="float: right">
                            <el-input v-model="searchName" @keyup.enter.native="changeStatus"   placeholder="请输入表名进行查询" style="width: 330px" size="mini">
                ...
                >
                    ...
                    <el-table-column label="操作" width="180">
                        <template slot-scope="scope">
                            ...
                            <el-button type="text" size="mini" v-if="scope.row.status==0" @click="dealOperate(scope.row)">处理</el-button>
                            <el-button type="text" size="mini"  v-if="scope.row.status==1" @click="operateLog(scope.row)">操作记录</el-button>
                        </template>
                    </el-table-column>
                </el-table>
                <el-pagination
        ...
        <deal-operate :dealOperateVisible="dealOperateVisible" :isdealOperate="isdealOperate" @dealOperateBack="dealOperateBack"></deal-operate>
        <operate-log :operateLogVisible="operateLogVisible" :isOperateLog="isOperateLog" @operateLogBack="operateLogBack"></operate-log>
        <question-detail :questionDetailVisible="questionDetailVisible" :isQuestionDetail="isQuestionDetail" @questionDetailBack="questionDetailBack"></question-detail>
    </section>
</template>
<script>
