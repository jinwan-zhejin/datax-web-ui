<template>
    <el-dialog
        ...
        <el-table stripe class="tb-edit" :data="tableData" style="width: 100%" height="320"  v-loading="isLoadingTable">
            <template v-for="(col ,index) in cols">
                ...
                >
                    <template slot-scope="scope" >
                        ...
                        <span style="color: #F67F89" v-if="scope.row[scope.column.property].errorMsgs" v-text="scope.row[scope.column.property].errorMsgs"></span>
                    </template>
                </el-table-column>
            </template>
        </el-table>
