<template>
<div>
    <el-table v-loading="listLoading" :data="list" element-loading-text="Loading" fit highlight-current-row :header-cell-style="{
        background: '#F8F8FA',
        'font-weight': 500,
        color: '#333333',
      }">
        ...
        <el-table-column label="操作" align="center" width="100">
            <template slot-scope="{ row }">
                <el-link v-show="row.executorAddress" type="primary" @click="handleViewJobLog(row)"><i class="el-icon-search" /> 日志查看</el-link>
