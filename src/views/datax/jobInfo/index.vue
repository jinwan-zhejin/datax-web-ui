                    ...
                    <el-dropdown @command="createNewJob">
                        ...
                        <el-dropdown-menu>
                            <el-dropdown-item command="NORMAL">
                               <svg-icon class="svg-icon"  icon-class="NORMAL" /> 普通任务
                            </el-dropdown-item>
                            <el-dropdown-item command="IMPORT"><svg-icon  class="svg-icon" icon-class="IMPORT" />引入任务</el-dropdown-item>
                            <el-dropdown-item command="EXPORT">
                                <svg-icon class="svg-icon"  icon-class="EXPORT" />导出任务
                            </el-dropdown-item>
                            <el-dropdown-item command="COMPUTE" disabled><svg-icon class="svg-icon"  icon-class="COMPUTE" />计算任务</el-dropdown-item>
                            <el-dropdown-item command="SQLJOB"><svg-icon class="svg-icon"  icon-class="SQLJOB" />SQL任务</el-dropdown-item>
                            <el-dropdown-item command="SPARK"><svg-icon class="svg-icon" icon-class="SPARK" />SPARK任务</el-dropdown-item>
                            <el-dropdown-item command="DQCJOB"><svg-icon class="svg-icon" icon-class="DQCJOB" />质量任务</el-dropdown-item>
                            <el-dropdown-item command="METACOLLECT" divided><svg-icon class="svg-icon" icon-class="METACOLLECT" />元数据采集任务</el-dropdown-item>
                            <el-dropdown-item command="METACOMPARE"><svg-icon class="svg-icon" icon-class="METACOMPARE" />元数据比较任务</el-dropdown-item>
                            <el-dropdown-item command="SHELL" divided><svg-icon class="svg-icon" icon-class="SHELL" />SHELL任务</el-dropdown-item>
                            <el-dropdown-item command="POWERSHELL"><svg-icon class="svg-icon" icon-class="POWERSHELL" />POWERSHELL任务</el-dropdown-item>
                            <el-dropdown-item command="PYTHON"><svg-icon class="svg-icon" icon-class="PYTHON" />PYTHON任务</el-dropdown-item>
                            <el-dropdown-item command="VJOB" divided><svg-icon class="svg-icon" icon-class="VJOB" />虚任务</el-dropdown-item>
                            <el-dropdown-item command="JAVA" divided disabled><svg-icon class="svg-icon" icon-class="JAVA" />Java任务</el-dropdown-item>
                            <el-dropdown-item command="SCALA" disabled><svg-icon class="svg-icon" icon-class="SCALA" />Scala任务</el-dropdown-item>
                            <el-dropdown-item command="PYSPARK" disabled><svg-icon class="svg-icon" icon-class="PYSPARK" />PySpark任务</el-dropdown-item>
                            <el-dropdown-item command="R" disabled><svg-icon class="svg-icon" icon-class="R" />R任务</el-dropdown-item>
                            <el-dropdown-item command="BATCH" divided><svg-icon class="svg-icon" icon-class="BATCH" />任务批量构建</el-dropdown-item>
                            <el-dropdown-item command="TEMPLATE"><svg-icon class="svg-icon" icon-class="TEMPLATE" />普通任务模板</el-dropdown-item>
                        </el-dropdown-menu>
                    </el-dropdown>
                </el-col>
            </el-row>
