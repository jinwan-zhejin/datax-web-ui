    ...
    <section class="standard-check-section main-outer">
        ...
        <el-row class="main-inner">
            <el-tabs v-model="tabType" type="border-card" :tab-position="tabPosition" @tab-click="tabClick">
                <el-tab-pane label="待审核标准" :key="1" name="check-standard">
                    <CheckStandardTab :checkStandardVisible="checkStandardVisible"></CheckStandardTab>
                </el-tab-pane>
                <el-tab-pane label="已审核标准" :key="2" name="checked-standard">
                    <CheckedStandardTab :checkedStandardVisible="checkedStandardVisible"></CheckedStandardTab>
                </el-tab-pane>
            </el-tabs>
        </el-row>
    </section>
