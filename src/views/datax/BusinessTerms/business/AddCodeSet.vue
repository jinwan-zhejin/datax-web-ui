<template>
    <el-dialog
        ...
        append-to-body>
        <el-form :model="addCodeSet" :rules="rules" ref="addCodeSet" size="small"  label-width="100px" label-position="right">
            <el-form-item label="代码集名称" prop="name">
                <el-input v-model="addCodeSet.name" maxlength="20" placeholder="最大长度为20个字符"></el-input>
            </el-form-item>
            <el-form-item label="代码集编号" prop="code">
                <el-input v-model="addCodeSet.code" maxlength="20" placeholder="最大长度为20个字符"></el-input>
            </el-form-item>
        ...
        <span slot="footer" class="dialog-footer">
                ...
                <el-button type="danger" size="small" @click="submitCodeSet('addCodeSet')">确 定</el-button>
            </span>
    </el-dialog>
</template>
...
<script>
    export default {
        ...
        watch:{
            isEditCodeSet:{//深度监听，可监听到对象、数组的变化
                handler(val, oldVal){
