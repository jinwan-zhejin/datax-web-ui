...
<div class="app-container">
    <div class="filter-container">
        <el-card class="box-card">
            <div class="text item">
                <div class="left">DataSource</div>
                <div class="right">
                    <el-input v-model="listQuery.datasourceName" clearable placeholder="Datasource Name" style="width: 268px" class="filter-item" @keyup.enter.native="handleFilter">
                        <el-button slot="append" v-waves size="small" style="margin: 0px;padding: 8.5px 0px;" class="filter-item" type="goon" @click="fetchData">Search</el-button>
                    </el-input>
    ...
    <div class="main">
        <el-table v-loading="listLoading" :data="list" element-loading-text="Loading" :header-cell-style="{ background: '#FAFAFC' }" fit highlight-current-row>
          ...
          <template slot-scope="scope">{{ scope.$index }}</template>
            ...
            <el-table-column label="DataSource" width="100" align="center">
            ...
            <el-table-column label="Group" width="140" align="center">
            ...
            <el-table-column label="ZK address" width="190" align="center" :show-overflow-tooltip="true">
                <template slot-scope="scope">{{
            scope.row.zkAdress ? scope.row.zkAdress : "-"
          }}</template>
            </el-table-column>
            <el-table-column label="Database" width="120" align="center" :show-overflow-tooltip="true">-->
                <template slot-scope="scope">{{
            ...
            <el-table-column min-width="200" label="Operation" align="center" class-name="small-padding fixed-width">
                <template slot-scope="{ row }">
                    <a style="color: #3d5fff; margin: 0px 6px" @click="handleUpdate(row)">Edit</a>
                    <span style="
                width: 1px;
                height: 12px;
                background: #e6e6e8;
              ...
              " />
                    <a style="color: #fe4646; margin: 0px 6px" @click="handleDelete(row)">Delete</a>
                    <span style="
                width: 1px;
                height: 12px;
                background: #e6e6e8;
                display: inline-block;
              " />
                    <a style="color: #3d5fff; margin: 0px 6px" :disabled="gathering" @click="gatherMetadata(row)">Metadata</a>
                </template>
            </el-table-column>
        </el-table>
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible" width="800px">
        <el-form ref="dataForm" :rules="rules" :model="temp" label-position="left" label-width="100px">
            ...
            <el-form-item v-if="mongodb" label="地址" prop="jdbcUrl">
                <el-input v-model="temp.jdbcUrl" :autosize="{ minRows: 3, maxRows: 6 }" type="textarea" placeholder="127.0.0.1:27017" style="width: 60%" />
            </el-form-item>
