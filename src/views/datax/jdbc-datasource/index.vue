...
<div class="app-container">
    <el-card shadow="never">
        <span style="font-size: 24px">普通数据源</span>
        <el-input v-model="listQuery.datasourceName" clearable placeholder="数据源名称" style="margin-left:56%; width: 268px;" @keyup.enter.native="handleFilter">
            <el-button slot="append" v-waves class="filter-item" type="primary" @click="fetchData">搜索</el-button>
        </el-input>
        <el-button class="filter-item" style="margin-left: 10px; background: #3D5FFF; color: #FFFFFF" icon="el-icon-plus" @click="handleCreate">
            添加
        </el-button>
    </el-card>
