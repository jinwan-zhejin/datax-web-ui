  ...
  <div class="app-container">
    <div class="build-container">
      <el-steps :active="active" finish-status="success">
        <el-step title="步骤 1" description="添加质量规则">1</el-step>
        <el-step title="步骤 2" description="选择结果数据存放位置">2</el-step>
      ...
      <div v-show="active===4" class="step4">
        ...
        <el-radio-group v-model="radio">
          <el-radio-button label="使用模板" type="primary" @click="handleJobTemplateSelectDrawer">{{ jobTemplate ? jobTemplate : "选择模板" }}</el-radio-button>
        ...
        <el-button v-show="isUse" type="info" @click="handleCopy(inputData,$event)">复制json</el-button>
      ...
      <el-dialog title="添加" :visible.sync="dialogFormVisible" width="1000px" :before-close="handleClose">
...
export default {
  name: 'JsonBuild',
  components: { Reader, Writer, Pagination, JsonEditor, ShellEditor, PythonEditor, PowershellEditor, Mapper, Cron },
  data() {
