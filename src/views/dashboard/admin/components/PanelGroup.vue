...
export default {
    ...
    data() {
        return {
            ...
            colList: ['Databases', 'Tables', 'Columns', 'Table Size', 'Records', 'DataSources', 'Avg Size/Table', 'Projects', 'Jobs', 'Job Distribution', 'Execution', 'Models', 'Rules', 'General Rules', 'Specific Rules']
        }
    },
    methods: {
