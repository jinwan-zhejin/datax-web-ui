    ...
    <section class="checked-standard-tab-section">
        ...
        <el-row class="mt20">
            ...
            >
                ...
                >
                    <template slot-scope="scope">
                        <el-tag class="success-tag" v-if="scope.row.auditResult==1">通过</el-tag>
                        <el-tag class="error-tag" v-if="scope.row.auditResult==2">退回</el-tag>
                    </template>
                </el-table-column>
                <el-table-column
                    label="操作"
                    width="100">
                    <template slot-scope="scope">
                        <el-button size="mini" @click="showDetail(scope.row.id)" type="text">审核记录</el-button>
                    </template>
                </el-table-column>
            </el-table>
            <el-pagination
