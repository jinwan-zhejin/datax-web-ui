  ...
  <el-popover placement="right" width="500" trigger="click">
    <el-tabs type="border-card">
      ...
      <el-tab-pane label="自定义">
        <h4>相对于今天<i class="el-icon-check" /></h4>
        <el-form :inline="true" :model="formInline" class="demo-form-inline">
          ...
          <el-form-item label="" class="customize">
            <el-input v-model="formInline.num" placeholder="" />
          </el-form-item>

          <el-form-item label="" class="customize">
            <el-select v-model="formInline.timeUnit" placeholder="">
          ...
          <h4>开始/结束<i class="el-icon-check" /></h4>
          <el-date-picker
            v-model="timeStr"
            type="datetimerange"
