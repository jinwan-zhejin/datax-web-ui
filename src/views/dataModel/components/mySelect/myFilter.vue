              ...
              >
                <el-form-item label="" class="customize">
                  <el-select v-model="formFilter.field" placeholder="">
                    <el-option v-for="(item, index) in $store.getters.allNodeFields" :key="index" :label="item" :value="item" />
                  </el-select>
                </el-form-item>
                <el-form-item label="" class="customize">
            ...
            <el-tab-pane label="自定义sql">
              <div class="filterMethod">
                <el-select v-model="filterMethod" placeholder="请选择">
                  <el-option label="HAVING" value="HAVING" />
                  <el-option label="WHERE" value="WHERE" />
                </el-select>
              </div>
              <el-input
                v-model="sql"
